...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Supplier.html_color'
        db.add_column('lizard_geodin_supplier', 'html_color', self.gf('django.db.models.fields.CharField')(default=u'#CCCCCC', max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Supplier.html_color'
        db.delete_column('lizard_geodin_supplier', 'html_color')
    ...
    models = {
        ...
        'lizard_geodin.supplier': {
            ...
            'html_color': ('django.db.models.fields.CharField', [], {'default': "u'#CCCCCC'", 'max_length': '20'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'db_index': 'True'})
        }
