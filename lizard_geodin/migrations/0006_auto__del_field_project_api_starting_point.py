...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('lizard_geodin_project', 'api_starting_point', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'location_types', null=True, to=orm['lizard_geodin.ApiStartingPoint'], blank=True), keep_default=False)
